...
server.post(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            jobTitle:registrationForm.customer.jobTitle.value,
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.jobTitle = registrationForm.jobTitle; //newly created
                                newCustomerProfile.custom.address = registrationForm.address;
                            }
                        });
                    } catch (e) {
                        if (e.authError) {
